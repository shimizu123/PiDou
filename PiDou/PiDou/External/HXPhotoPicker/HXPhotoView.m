...
- (NSString *)addImageName {
    if (!_addImageName) {
        ...
        _addImageName = @"publish_addphoto";
    }
...
#pragma mark - < 更新高度 >
- (void)setupNewFrame {
    CGFloat itemW = (self.hx_w - self.InteritemSpacing * (self.lineCount - 1)) / self.lineCount - 0.1;
...
- (void)layoutSubviews {
    ...
    if (dataCount == 1) {
        CGFloat itemW = (width - self.InteritemSpacing * (self.lineCount - 1)) / self.lineCount - 0.1;
