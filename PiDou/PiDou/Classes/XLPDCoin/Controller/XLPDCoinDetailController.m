...
@interface XLPDCoinDetailController () <UITableViewDelegate, UITableViewDataSource>
...
@implementation XLPDCoinDetailController

- (void)viewDidLoad {
    [super viewDidLoad];
    
    self.navigationItem.title = @"PDCoin明细";
...
- (void)initData {
    kDefineWeakSelf;
    [XLPDCoinHandle pdCoinBillPage:self.page success:^(id  _Nonnull responseObject) {
