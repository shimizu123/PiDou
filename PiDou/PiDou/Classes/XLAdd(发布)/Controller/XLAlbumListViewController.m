...
#import "XLAlbumListViewController.h"
#import "HXPhotoViewController.h"
#import "UIViewController+HXExtension.h"

@interface XLAlbumListViewController ()
<
...
@implementation XLAlbumListViewController
...
- (void)cancelClick {
    ...
    if ([self.delegate respondsToSelector:@selector(xl_albumListViewControllerDidCancel:)]) {
        [self.delegate xl_albumListViewControllerDidCancel:self];
    }
    if (self.cancelBlock) {
...
- (void)photoViewController:(HXPhotoViewController *)photoViewController didDoneAllList:(NSArray<HXPhotoModel *> *)allList photos:(NSArray<HXPhotoModel *> *)photoList videos:(NSArray<HXPhotoModel *> *)videoList original:(BOOL)original {
    if ([self.delegate respondsToSelector:@selector(xl_albumListViewController:didDoneAllList:photos:videos:original:)]) {
        [self.delegate xl_albumListViewController:self didDoneAllList:allList photos:photoList videos:videoList original:original];
    }
    if (self.doneBlock) {
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
    XLAlbumListQuadrateViewCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:@"cellId" forIndexPath:indexPath];
    cell.indexPath = indexPath;
    cell.model = self.albumModelArray[indexPath.item];
    
    HXWeakSelf
    cell.getResultCompleteBlock = ^(NSInteger count, XLAlbumListQuadrateViewCell *myCell) {
        if (count <= 0) {
...
- (void)collectionView:(UICollectionView *)collectionView didEndDisplayingCell:(UICollectionViewCell *)cell forItemAtIndexPath:(NSIndexPath *)indexPath {
    [(XLAlbumListQuadrateViewCell *)cell cancelRequest];
}
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    XLAlbumListSingleViewCell *cell = [tableView dequeueReusableCellWithIdentifier:@"tableViewCellId"];
    cell.model = self.albumModelArray[indexPath.row];
    
    //    HXWeakSelf
    //    cell.getResultCompleteBlock = ^(NSInteger count, XLAlbumListSingleViewCell *myCell) {
    //        if (count <= 0) {
    //            if ([weakSelf.albumModelArray containsObject:myCell.model]) {
...
- (void)tableView:(UITableView *)tableView didEndDisplayingCell:(UITableViewCell *)cell forRowAtIndexPath:(NSIndexPath *)indexPath {
    [(XLAlbumListSingleViewCell *)cell cancelRequest];
}
...
- (UIViewController *)previewingContext:(id<UIViewControllerPreviewing>)previewingContext viewControllerForLocation:(CGPoint)location {
    ...
    XLAlbumListQuadrateViewCell *cell = (XLAlbumListQuadrateViewCell *)[self.collectionView cellForItemAtIndexPath:indexPath];
    //设置突出区域
...
- (UITableView *)tableView {
    if (!_tableView) {
        ...
        [_tableView registerClass:[XLAlbumListSingleViewCell class] forCellReuseIdentifier:@"tableViewCellId"];
#ifdef __IPHONE_11_0
    ...
    - (UICollectionView *)collectionView {
        if (!_collectionView) {
            ...
            [_collectionView registerClass:[XLAlbumListQuadrateViewCell class] forCellWithReuseIdentifier:@"cellId"];
        ...
        @interface XLAlbumListQuadrateViewCell ()
        ...
        @implementation XLAlbumListQuadrateViewCell
...
#pragma mark - < cell懒加载 >
        ...
        @interface XLAlbumListSingleViewCell ()
        ...
        @implementation XLAlbumListSingleViewCell
